...
exports.get = (query, { sort= { _id: 1}, limit=10, page=1 }, callback) => {
    const getQuery = Message.find(query).limit(limit).skip((page - 1) * limit).sort(sort);
